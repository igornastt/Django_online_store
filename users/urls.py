...
from users.views import LoginView, LogoutView, RegisterView, UserUpdateView, generate_password, UserConfirmEmailView, UserConfirmedView, password_reset, UserConfirmationSentView
